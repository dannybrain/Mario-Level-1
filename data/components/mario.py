...
class Mario(pg.sprite.Sprite):
    ...
    def shoot_fireball(self, powerup_group):
        ...
        if (self.current_time - self.last_fireball_time) > 200:
            if self.fireball_count < 2:
                ...
                powerup_group.add(
                    powerups.FireBall(self.rect.right,
                                      self.rect.y, 
                                      self.facing_right))
    ...
    def changing_to_fire(self):
        ...
        elif (self.current_time - self.fire_transition_timer) > 65 \
                and (self.current_time - self.fire_transition_timer) < 130:
            self.image = frames[0]
    ...
    def walking_to_castle(self):
        ...
        if (self.walking_timer == 0 or
                (self.current_time - self.walking_timer) > 200):
            self.walking_timer = self.current_time
