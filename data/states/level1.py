...
from data import game_sound
from data.components import mario
from data.components import collider
from data.components import bricks
from data.components import coin_box
from data.components import enemies
from data.components import checkpoint
from data.components import flagpole
...
class Level1(tools._State):
    ...
    def setup_coin_boxes(self):
        ...
        coin_box5 = coin_box.Coin_box(
            3342, 365, c.MUSHROOM, self.powerup_group)
        ...
        coin_box9 = coin_box.Coin_box(
            4672, 193, c.MUSHROOM, self.powerup_group)
    ...
    def check_enemy_x_collisions(self, enemy):
        ...
        collider = pg.sprite.spritecollideany(
            enemy, self.ground_step_pipe_group)
    ...
    def check_shell_x_collisions(self, shell):
        ...
        collider = pg.sprite.spritecollideany(
            shell, self.ground_step_pipe_group)
    ...
    def check_mushroom_x_collisions(self, mushroom):
        ...
        collider = pg.sprite.spritecollideany(
            mushroom, self.ground_step_pipe_group)
    ...
    def check_star_y_collisions(self, star):
        ...
        collider = pg.sprite.spritecollideany(
            star, self.ground_step_pipe_group)
